...
class pagesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PagesBundle:Pages')->findBy(array(),array('genre' => 'ASC', 'ordre'=>'ASC'));
        //dump($entities);
        //var_dump($entities);
        //die();
    ...
    */
    private function createEditForm(Pages $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Enregistrer les modifications',  'attr'=>array('class'=>'btn btn-success') ));
